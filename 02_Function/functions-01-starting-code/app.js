...
const sumUp = (a, b, ...numbers) => {     // rest 연산자 : 여러 개의 인자를 받아 배열로 만들어줌 
...
const subtractUp = function() {  
  let sum = 0;
  for (const num of arguments) {    // arguments : 함수 내부에서 사용 가능한 특별한 변수
    sum -= num;
  }
  return sum;
};

console.log(sumUp(1, 5, 10, 'ab', 'test', -3, 6, 10));  // 29
console.log(sumUp(1, 5, 10, -3, 10, 25, 88));   // 136
console.log(subtractUp(1, 10, 15, 20));  // 0